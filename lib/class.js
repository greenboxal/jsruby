...
var makeMetaclass = function(klass) {
	var metaclass = exports.boot(null, 'Metaclass$' + klass.__iclass__.name);
...
var makeSingletonClass = function(obj) {
	...
	var klass = exports.boot(origClass);
...
exports.setSuperclass = function(klass, superclass) {
	...
	if (superclass) {
		var superintern = superclass.__iclass__;

		Object.setPrototypeOf(klass.prototype, superclass.prototype);

		if (superintern) {
			Object.setPrototypeOf(intern, superintern);
		}
	} else {
...
exports.alloc = function(klass, name) {
	...
	var obj = new Function("fn", "return function " + name + "() { return fn.apply(this, arguments) };")(function() {
		return obj.create.apply(obj, arguments);
	});
