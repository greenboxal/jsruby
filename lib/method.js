...
var kernelSingletonMethod = function(name) {
	return this.metaclass.method(name);
};

var kernelDefineSingletonMethod = function(name, fn) {
	return this.metaclass.defineMethod(name, fn);
};
...
var moduleDefineMethod = function(name, fn) {
	if (!fn) {
		fn = name;
		name = null;
	}
...
exports.init = function() {
	...
	RubyClass.defineMethod(Ruby.Kernel, "method", kernelMethod);
	RubyClass.defineMethod(Ruby.Kernel, "singletonMethod", kernelSingletonMethod);
	RubyClass.defineMethod(Ruby.Kernel, "defineSingletonMethod", kernelDefineSingletonMethod);
	RubyClass.defineMethod(Ruby.Module, "defineMethod", moduleDefineMethod);
