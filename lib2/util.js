...
exports.patchNativeClass = function(klass, superclass) {
	var proto = Object.getPrototypeOf(klass);

	exports.patchMetaclass(klass, superclass, superclass.metaclass, klass.name);
	exports.copyAllProperties(proto, klass.metaclass, ['constructor', 'name']);
};
